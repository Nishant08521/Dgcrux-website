...
import { CheckCircle2, Smartphone, Globe, Code2, Zap } from "lucide-react"
    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-background to-muted/20 py-20 sm:py-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <Badge className="mb-6">Application Development</Badge>
            <h1 className="text-balance text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
              Application Development Services
            </h1>
            <p className="mt-6 text-pretty text-lg leading-relaxed text-muted-foreground">
              Build powerful applications that drive business growth and enhance user experiences.
            </p>
            <div className="mt-10">
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
                We deliver high-quality applications that meet your business objectives.
              </p>
            </div>
      ...
      <section className="py-24 bg-background">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl">Ready to Build Your Application?</h2>
          <div className="mt-8">
            <Button size="lg" asChild>
