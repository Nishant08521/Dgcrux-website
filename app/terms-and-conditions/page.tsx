    ...
    <main className="min-h-screen scroll-smooth">
      ...
      <section className="bg-primary text-primary-foreground py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <h1 className="text-3xl font-bold uppercase tracking-wide">Terms & Conditions</h1>
      ...
      <section className="bg-background py-12">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-8 text-muted-foreground leading-relaxed">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">TERMS OF SERVICE</h2>
            <p className="text-sm text-muted-foreground/80">Last updated January 21, 2023</p>
          </div>

          <div>
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-4">TABLE OF CONTENTS</h3>
            <ol className="list-decimal list-inside space-y-2 ml-4">
              <li>
                <a href="#agreement-to-terms" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  AGREEMENT TO TERMS
                </a>
              </li>
              <li>
                <a href="#intellectual-property-rights" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  INTELLECTUAL PROPERTY RIGHTS
                </a>
              </li>
              <li>
                <a href="#user-representations" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  USER REPRESENTATIONS
                </a>
              </li>
              <li>
                <a href="#prohibited-activities" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  PROHIBITED ACTIVITIES
                </a>
              </li>
              <li>
                <a href="#user-generated-contributions" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  USER GENERATED CONTRIBUTIONS
                </a>
              </li>
              <li>
                <a href="#contribution-license" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  CONTRIBUTION LICENSE
                </a>
              </li>
              <li>
                <a href="#submissions" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  SUBMISSIONS
                </a>
              </li>
              <li>
                <a href="#site-management" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  SITE MANAGEMENT
                </a>
              </li>
              <li>
                <a href="#privacy-policy" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  PRIVACY POLICY
                </a>
              </li>
              <li>
                <a href="#term-and-termination" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  TERM AND TERMINATION
                </a>
              </li>
              <li>
                <a href="#modifications-and-interruptions" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  MODIFICATIONS AND INTERRUPTIONS
                </a>
              </li>
              <li>
                <a href="#governing-law" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  GOVERNING LAW
                </a>
              </li>
              <li>
                <a href="#dispute-resolution" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  DISPUTE RESOLUTION
                </a>
              </li>
              <li>
                <a href="#corrections" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  CORRECTIONS
                </a>
              </li>
              <li>
                <a href="#disclaimer" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  DISCLAIMER
                </a>
              </li>
              <li>
                <a href="#limitations-of-liability" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  LIMITATIONS OF LIABILITY
                </a>
              </li>
              <li>
                <a href="#indemnification" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  INDEMNIFICATION
                </a>
              </li>
              <li>
                <a href="#user-data" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  USER DATA
                </a>
              </li>
              <li>
                <a href="#electronic-communications" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
                </a>
              </li>
              <li>
                <a href="#california-users-and-residents" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  CALIFORNIA USERS AND RESIDENTS
                </a>
              </li>
              <li>
                <a href="#miscellaneous" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  MISCELLANEOUS
                </a>
              </li>
              <li>
                <a href="#contact-us" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  CONTACT US
                </a>
              </li>
            </ol>
          ...
          <div id="agreement-to-terms" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">1. AGREEMENT TO TERMS</h3>
            <p>
              These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf
              of an entity (&quot;you&quot;) and DGCRUX TECHNOLOGY PRIVATE LIMITED , doing business as DgCrux, Bulk SMS
              Factory (&quot; DgCrux, Bulk SMS Factory ,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;),
              ...
              linked, or otherwise connected thereto (collectively, the &quot;Site&quot;). We are registered in India and
              have our registered office at 108, Tower- 16, Janaadhar shubha phase-2, Attibele-Anekal road , Bangalore ,
              Karnataka 562107 . You agree that by accessing the Site, you have read, understood, and agreed to be bound
              by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY
          ...
          <div id="intellectual-property-rights" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">2. INTELLECTUAL PROPERTY RIGHTS</h3>
            <p>
              ...
              on the Site &quot;AS IS&quot; for your information and personal use only. Except as expressly provided in
          ...
          <div id="user-representations" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">3. USER REPRESENTATIONS</h3>
            <p>
          ...
          <div id="prohibited-activities" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">4. PROHIBITED ACTIVITIES</h3>
            <p>
            ...
            <p className="mt-3">As a user of the Site, you agree not to:</p>
            <ul className="list-disc list-inside mt-3 space-y-2 ml-4">
              ...
              <li>
                ...
                formats (&quot;gifs&quot;), 1×1 pixels, web bugs, cookies, or other similar devices (sometimes referred
          ...
          <div id="user-generated-contributions" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">5. USER GENERATED CONTRIBUTIONS</h3>
            <p>
          ...
          <div id="contribution-license" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">6. CONTRIBUTION LICENSE</h3>
            <p>
            ...
            <p className="mt-3">
              ...
              to exonerate us from any and all responsibility and to refrain from any legal action against us regarding
              your Contributions.
            </p>
          </div>

          <div id="submissions" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">7. SUBMISSIONS</h3>
            <p>
          ...
          <div id="site-management" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">8. SITE MANAGEMENT</h3>
            <p>
          ...
          <div id="privacy-policy" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">9. PRIVACY POLICY</h3>
            <p>
              ...
              <Link
                ...
                className="text-primary hover:text-yellow-400 hover:underline transition-colors"
              >
                https://dgcrux.com/privacy-policy
              </Link>
              . By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of
              Use. Please be advised the Site is hosted in India . If you access the Site from any other region of the world
              with laws or other requirements governing personal data collection, use, or disclosure that differ from
              applicable laws in India , then through your continued use of the Site, you are transferring your data to
              India , and you agree to have your data transferred to and processed in India .
            </p>
          </div>

          <div id="term-and-termination" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">10. TERM AND TERMINATION</h3>
            <p>
          ...
          <div id="modifications-and-interruptions" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">11. MODIFICATIONS AND INTERRUPTIONS</h3>
            <p>
              ...
              also reserve the right to modify or discontinue all or part of the Site without notice at any time. We will not
          ...
          <div id="governing-law" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">12. GOVERNING LAW</h3>
            <p>
              These Terms shall be governed by and defined following the laws of India . DGCRUX TECHNOLOGY PRIVATE LIMITED
              and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any
              dispute which may arise in connection with these terms.
            </p>
          </div>

          <div id="dispute-resolution" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">13. DISPUTE RESOLUTION</h3>
            <p className="font-semibold text-foreground">Informal Negotiations</p>
            <p className="mt-2">
            ...
            <p className="mt-3 font-semibold text-foreground">Binding Arbitration</p>
            <p className="mt-2">
              ...
              arbitrators shall be two (2). The seat, or legal place, of arbitration shall be Bangalore, India . The
              language of the proceedings shall be English. The governing law of the contract shall be the substantive law of
              India .
            </p>
            <p className="mt-3 font-semibold text-foreground">Restrictions</p>
            <p className="mt-2">
            ...
            <p className="mt-3 font-semibold text-foreground">Exceptions to Informal Negotiations and Arbitration</p>
            <p className="mt-2">
              ...
              Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall
              be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties
              agree to submit to the personal jurisdiction of that court.
            </p>
          </div>

          <div id="corrections" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">14. CORRECTIONS</h3>
            <p>
          ...
          <div id="disclaimer" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">15. DISCLAIMER</h3>
            <p>
              ...
              LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN
              ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT
              POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SITE. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME
          ...
          <div id="limitations-of-liability" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">16. LIMITATIONS OF LIABILITY</h3>
            <p>
          ...
          <div id="indemnification" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">17. INDEMNIFICATION</h3>
            <p>
          ...
          <div id="user-data" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">18. USER DATA</h3>
            <p>
          ...
          <div id="electronic-communications" className="scroll-mt-20">
            ...
            <p>
              ...
              retention of non-electronic records, or to payments or the granting of credits by any means other than electronic
              means.
            </p>
          </div>

          <div id="california-users-and-residents" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">20. CALIFORNIA USERS AND RESIDENTS</h3>
            <p>
          ...
          <div id="miscellaneous" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">21. MISCELLANEOUS</h3>
            <p>
          ...
          <div id="contact-us" className="scroll-mt-20">
            <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">22. CONTACT US</h3>
            <p>In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at:</p>
            <div className="mt-4 space-y-2">
              <p className="font-semibold text-foreground">DGCRUX TECHNOLOGY PRIVATE LIMITED</p>
              <p>108, Tower- 16, Janaadhar shubha phase-2, Attibele-Anekal road</p>
              <p>Bangalore , Karnataka 562107</p>
              <p>India</p>
              <p>
                Phone:{" "}
                <a href="tel:+919835166140" className="text-primary hover:text-yellow-400 hover:underline transition-colors">
                  (+91)9835166140
                </a>
              </p>
              <p>
